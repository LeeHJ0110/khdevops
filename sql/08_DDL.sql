...
DROP TABLE MEMBER;
CREATE TABLE MEMBER(
    ID          VARCHAR2(10)    CONSTRAINT MEMBER_ID_NN NOT NULL CONSTRAINT MEMBER_ID_UQ UNIQUE
    , PW        VARCHAR2(100)   NOT NULL
    , NICK      VARCHAR2(10)    CONSTRAINT MEMBER_NICK_UQ UNIQUE
    , GENDER    CHAR(1)         CONSTRAINT MEMBER_GENDER_CH CHECK(GENDER IN('M', 'F'))
...
*/
INSERT INTO MEMBER(ID, PW, NICK, GENDER) VALUES('USER01', '1234', 'NICK01','M');
INSERT INTO MEMBER(ID, PW, NICK, GENDER, CREATED_AT) VALUES('USER02', '1234', 'NICK02','D', SYSDATE);
...
CREATE TABLE MEMBER(
    ...
    , ID            VARCHAR2(20)    CONSTRAINT MEMBER_ID_NN NOT NULL CONSTRAINT MEMBER_ID_UQ UNIQUE
    , PW            VARCHAR2(100)   CONSTRAINT MEMBER_PW_NN NOT NULL
    , NICK          VARCHAR2(20)    CONSTRAINT MEMBER_NICK_UQ UNIQUE
    , GENDER        CHAR(1)         CONSTRAINT MEMBER_GENDER_CH CHECK (GENDER IN('M', 'F'))
    , AGE           NUMBER          CONSTRAINT MEMBER_AGE_CH CHECK (AGE > 0)
    , CREATED_AT    TIMESTAMP       DEFAULT SYSDATE
);
INSERT INTO MEMBER 
(
...
CREATE TABLE BOARD(
    ...
    , WRITER_NO     NUMBER          REFERENCES MEMBER(NO)
);
SELECT * FROM BOARD;
