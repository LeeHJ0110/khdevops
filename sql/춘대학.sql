...
/* EX )
    ...
    ...
*/
SELECT DEPARTMENT_NAME || '의 정원은 ' || CAPACITY || '명 입니다.' "학과당 정원"
FROM TB_DEPARTMENT
;
...
FROM TB_STUDENT
ORDER BY DEPARTMENT_NO, STUDENT_NO, STUDENT_NAME, ENTRANCE_DATE
;
-- 2번
...
ORDER BY SUBSTR(PROFESSOR_SSN, 0, 6) DESC, PROFESSOR_NAME
;
...
SELECT DEPARTMENT_NO "학과 번호", COUNT(DECODE(ABSENCE_YN, 'Y', 1, NULL)) 휴학생수
FROM TB_STUDENT
GROUP BY DEPARTMENT_NO
;
