...
*/
-- EMPLOYEE 테이블에서 전체 사원의 이름, 전화번호 조회
...
*/
-- EMPLOYEE 테이블에서 전체 사원의 이름, 연봉 조회
SELECT EMP_NAME, SALARY * 12
FROM EMPLOYEE
;
-- EMPLOYEE 테이블에서 직원명, 연봉, 보너스가 포함된 연봉((급여 + (급여 * 보너스)) * 12) 조회
SELECT EMP_NAME, SALARY * 12 , (SALARY + (SALARY * BONUS)) * 12 
FROM EMPLOYEE
;
-- EMPLOYEE 테이블에서 직원명, 입사일, 근무일수
-- DATE 타입 간 연산 가능
-- SYSDATE로 현재 시간 확인 가능
...
*/
SELECT EMP_NAME, SALARY * 12 AS 연봉, (SALARY + (SALARY * BONUS)) * 12 AS 보너스
FROM EMPLOYEE
;
/*
    <리터럴>
...
*/
SELECT EMP_NAME || '의 월급은 ' || SALARY || '원 입니다.' AS "이름 및 월급"
FROM EMPLOYEE
;
--------------------------------------------------------------------------
/*
